Feature: CAMARA Consent Info API, vwip - Operation verifyStatus
  ...
  Background: Common verifyStatus setup
    Given an environment at "apiRoot"
    And the resource "/consent-info/vwip/verify"
    ...
    And the request body is set by default to a request body compliant with the schema at "/components/schemas/VerifyStatusRequestBody"

  # Success scenarios

  # This first scenario serves as a minimum, not testing any specific status
  @consent_info_verifyStatus_01_generic_success_scenario
  Scenario: Common validations for any success scenario
    Given a valid phone number identified by the token or provided in the request body
    When the request "verifyStatus" is sent
    Then the response status code is 200
    And the response header "Content-Type" is "application/json"
    And the response header "x-correlator" has same value as the request header "x-correlator"
    And the response body complies with the OAS schema at "/components/schemas/VerifyStatusResponseBody"

  @consent_info_verifyStatus_02_valid_for_processing
  ...
  @consent_info_verifyStatus_03_not_valid_for_processing
  ...
  @consent_info_verifyStatus_04_valid_for_processing_expiration_date
  ...
  Scenario: API Consumer requests API Provider to return a Consent capture URL
    ...
    And the response property "$.statusInfo[*].scopes" is either equal to or a subset of the requested scopes
    And the response property "$.statusInfo[*].purpose" matches the requested purpose
    And the response property "$.statusInfo[*].legalBasis" is "dpv:Consent"
    And the response property "$.statusInfo[*].statusValidForProcessing" is false
  ...
  @consent_info_verifyStatus_C02.01_phone_number_not_schema_compliant
  ...
  @consent_info_verifyStatus_C02.02_phone_number_not_found
  ...
  @consent_info_verifyStatus_C02.03_unnecessary_phone_number
  ...
  @consent_info_verifyStatus_C02.04_missing_phone_number
  ...
  @consent_info_verifyStatus_C02.05_phone_number_not_supported
  ...
  @consent_info_verifyStatus_400.1_schema_not_compliant
  Scenario: Invalid Argument. Generic Syntax Exception
    Given the request body is set to any value which is not compliant with the schema at "/components/schemas/VerifyStatusRequestBody"
    When the request "verifyStatus" is sent
    Then the response status code is 400
    And the response property "$.status" is 400
    And the response property "$.code" is "INVALID_ARGUMENT"
  ...
  @consent_info_verifyStatus_400.2_no_request_body
  ...
  @consent_info_verifyStatus_400.3_empty_request_body
  ...
  @consent_info_verifyStatus_400.4_x_correlator_not_compliant
  ...
  @consent_info_verifyStatus_401.1_no_authorization_header
  ...
  @consent_info_verifyStatus_401.2_expired_access_token
  ...
  @consent_info_verifyStatus_401.3_invalid_access_token
  ...
  @consent_info_verifyStatus_403.1_invalid_token_permissions
  ...
  @consent_info_verifyStatus_01_not_allowed_scopes_purpose
  ...
  @consent_info_verifyStatus_02_capture_frequency_exceeded
